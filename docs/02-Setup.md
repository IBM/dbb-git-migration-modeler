...
| MOVE_FILES_FLAG | This flag specifies if, during the Usage Assessment phase, files should be moved or not to the application's repository that supposedly owns them. |  `true` |
