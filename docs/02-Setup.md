...
| DBB_ZBUILDER | The path to a customized [zBuilder](https://www.ibm.com/docs/en/adffz/dbb/3.0.x?topic=zbuilder-getting-started) on z/OS Unix System Services for baseline builds during [The Initialization phase](01-Storyboard.md#the-initialization-phase). | `/var/dbb/dbb-zappbuild` |
