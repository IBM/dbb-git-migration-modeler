...
def addApplicationDependency(ApplicationDescriptor applicationDescriptor, String applicationDependency, String reference, String buildid) {
	if (!applicationDescriptor.dependencies) {
	...
	if (!existingDependencies) {
		...
		dependency.type = "release" // hard-coded
...
/**
 * Method to return an ArrayList that contains relative Paths
...
def addBaseline(ApplicationDescriptor applicationDescriptor, String branch, String type, String reference) {
	...
	newBaseline.buildid = "baseline"  // hard-coded default identifier
