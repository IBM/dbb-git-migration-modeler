...
export DBB_MODELER_HOME=/u/mdalbin/Migration-Modeler-MDLB
export DBB_MODELER_WORK=/u/mdalbin/Migration-Modeler-MDLB-work
export DBB_MODELER_APPCONFIGS=$DBB_MODELER_WORK/work-configs
